...
description: "Bringing external connections into a VXLAN fabric using a border leaf with both L2 VLAN extension and an L3 eBGP handoff to a firewall."
---
...
![VXLAN-EX-l2](/blog/assets/external-connection-l2.png)
