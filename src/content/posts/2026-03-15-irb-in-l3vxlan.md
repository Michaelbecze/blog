...
date: 2026-03-15
tags: ["VXLAN", "EVPN", "IRB"]
description: "An explanation of IRB in VXLAN fabrics, covering both Asymmetric and Symmetric IRB models and their forwarding trade-offs."
---
...
![VXLAN-IRB-AS](/blog/assets/VXLAN-IRB-AS.drawio.png)
...
![VXLAN-IRB-SYM](/blog/assets/VXLAN-IRB.SYM1.png)

---
## Gateway Models
There a 2 models that are used when it comes to where the L3 Gateway should be for each subenet in the EVPN VXLAN Fabric:
...
![VXLAN-IRB-DAG](/blog/assets/VXLAN-IRB-DAG.png)
