...
description: "Setting up a basic VXLAN EVPN deployment on Cisco Catalyst switches using MP-BGP EVPN as the control plane."
---
...
![Basic Lab set up](/blog/assets/east-west-vxlan.png)
- **WEST-CSW:** `10.100.1.1`
- **EAST-CSW:** `10.100.1.2`
...
![Leaning Mac Address' of both host](/blog/assets/l2vpn-evpn-macs.png)
