...
description: "Configuring Symmetric IRB with an Anycast Gateway in a VXLAN EVPN fabric on Cisco Catalyst IOS-XE, with both L2 and L3 VNIs."
---

In this post, we walk through a practical configuration of **Symmetric Integrated Routing and Bridging (IRB)** using an **Anycast Gateway** in a VXLAN EVPN fabric. If you are new to IRB, I previously covered the forwarding mechanics in detail [here](/blog/posts/2026-03-15-irb-in-l3vxlan/), so this article focuses primarily on implementation.
...
![VXLAN-IRB-SYM](/blog/assets/VXLAN-Symmetric-IRB.png)
...
![VXLAN-IRB-SYM](/blog/assets/VXLAN-IRB-lab.png)
