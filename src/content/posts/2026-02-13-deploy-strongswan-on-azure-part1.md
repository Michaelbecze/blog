...
description: "Deploying StrongSwan on an Ubuntu VM in Azure to establish a policy-based IPSec VPN tunnel to an on-premises Cisco IOS-XE router."
---
...
---
## The Lab Topology
![Basic Lab set up](/blog/assets/Azure-StrongSwan-Topo.drawio.png)
